/**
 * CS 2110 Fall 2021 HW1 Part 1 - Coding a bit vector
 *
 * @author Lucas Luwa
 *
 ...
 *         variables. - You may not declare any objects. - You may not use
 *         switch statements. - You may not use casting. - You may not use the
 *         unsigned right shift operator (>>>) - You may not write any helper
 *         methods, or call any method from this or another file to implement
 *         any method. Recursive solutions are not permitted. - You may only
 *         perform addition or subtraction with the number 1.
 *
 *         Method-specific rules for this file: - All methods must be done in
 *         one line, except for: zerosCount, onesCount, and size. - Looping and
 *         conditionals as described above are only allowed for: zerosCount,
 *         onesCount, and size - You can only use addition and subtraction in:
...
public class BitVector {
     ...
     * 
     * @param index index of which bit to set. 0 for the least significant bit
    ...
    public void set(int index) {
        ...
        //     holder *= 2;
        // }
        // System.out.println("holder" + Integer.toBinaryString(holder));
        bits = bits | 1<<index;
    }
     ...
     * 
     * @param index index of which bit to check. 0 for the least significant bit
     *              (right-most bit). 31 for the most significant bit.
     * @return true if the bit is set, false if the bit is clear. If the index is
     *         out of range (index >= 32), then return false.
     */
     ...
     * @param index index of which bit to check. 0 for the least significant bit
     *              (right-most bit). 31 for the most significant bit.
     * @return true if the bit is clear, false if the bit is set. If the index is
     *         out of range (index >= 32), then return true.
     */
    ...
    /**
     * Returns the number of bits currently set (=1) in this bit vector. You may use
     * the ++ operator to increment your counter.
     */
    ...
    /**
     * Returns the number of bits currently clear (=0) in this bit vector. You may
     * use the ++ operator to increment your counter.
     */
